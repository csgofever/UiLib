...
function library.new(library_title, cfg_location)
    ...
    function menu.new_tab(tab_image)
        ...
        if is_first_tab then
            ...
            TabImage.ImageColor3 = Color3.fromRGB(147, 51, 234)
            Tab.Visible = true
        end
        ...
        TabButton.MouseButton1Down:Connect(function()
            ...
            Tab.Visible = true
            selected_tab = TabButton
            library:tween(TabImage, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(147, 51, 234)})
        end)
        ...
        function tab.new_section(section_name)
            ...
            SectionButton.MouseButton1Down:Connect(function()
                ...
                library:tween(SectionButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(147, 51, 234)})
            ...
            if is_first_section then
                ...
                SectionButton.TextColor3 = Color3.fromRGB(147, 51, 234) 
            ...
            function section.new_sector(sector_name, sector_side)
                ...
                function sector.element(type, text, data, callback, c_flag)
                    ...
                    if type == "Toggle" then
                        ...
                        function element:set_value(new_value, cb)
                            ...
                            if value.Toggle then
                                library:tween(ToggleFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(147, 51, 234)})
                        ...
                        function element:add_keybind(key_default, key_callback)
                            ...
                            KeybindFrame.MouseEnter:Connect(function()
                                keybind_in2 = true
                                library:tween(KeybindFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(147, 51, 234)})
                            end)
                            ...
                            for _,TypeButton in next, KeybindFrame:GetChildren() do
                                ...
                                TypeButton.MouseButton1Down:Connect(function()
                                    ...
                                    library:tween(TypeButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(147, 51, 234)})
                                end)
                            end
                            ...
                            function keybind:set_value(new_value, cb)
                                ...
                                for _,TypeButton2 in next, KeybindFrame:GetChildren() do
                                    ...
                                    if TypeButton2.Name ~= extra_value.Type then
                                        ...
                                        library:tween(TypeButton2, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(147, 51, 234)})
                                    end
                                end
                        ...
                        function element:add_color(color_default, has_transparency, color_callback)
                            ...
                            ColorFrame.MouseEnter:Connect(function()
                                in_color = true
                                library:tween(ColorFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(147, 51, 234)})
                            end)
                    ...
                    elseif type == "Button" then
                        ...
                        Button.MouseButton1Down:Connect(function()
                            Button.BorderColor3 = Color3.fromRGB(147, 51, 234)
                    ...
                    elseif type == "Keybind" then
                        ...
                        uis.InputBegan:Connect(function(input)
                            if is_binding then
                                ...
                                if new_key == "Escape" then
                                    -- Escape cancels the action and restores the old key
                                    KeybindBtn.Text = "[ " .. tostring(value.Key):upper() .. " ]"
                                    return
                                elseif new_key == "Backspace" then
                                    new_key = "None"
                                end
                    ...
                    elseif type == "Scroll" then
                        ...
                        local ScrollFrame = library:create("ScrollingFrame", {
                            ...
                            TopImage = "rbxasset://textures/ui/Scroll/scroll-middle.png",
                            AnchorPoint = Vector2.new(0.5, 0),
                            ScrollBarImageColor3 = Color3.fromRGB(147, 51, 234),
                        }, Scroll)
                    ...
                    elseif type == "Slider" then
                        ...
                        local UIGradient = library:create("UIGradient", {
                            Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(147, 51, 234)), ColorSequenceKeypoint.new(1, Color3.fromRGB(112, 40, 176))},
                            Rotation = 90,
                        }, SliderFrame)
